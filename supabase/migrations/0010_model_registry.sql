-- Model registry: central catalog of all LLM providers/models with per-token pricing.
-- Used by the gateway to compute cost_usd on every llm_call event.
...
-- Seed: OpenAI + Anthropic models with pricing as of 2026-03
