...
export const ADMIN_ROUTES: Array<{ path: string; method: string }> = [
  ...
  { path: "/api/admin/flags", method: "PATCH" },
  { path: "/api/admin/flags", method: "POST" },
  { path: "/api/admin/flags/preview", method: "POST" },
  ...
  { path: "/api/admin/recipes/cookbook/:entryId/canon/retry", method: "POST" },
