...
export const ADMIN_PAGES: AdminPageMeta[] = [
  ...
  },
  {
    ...
    description: "For You algorithm lift, cold-start coverage, and ranking quality.",
  ...
  },
  {
    ...
    title: "Personalization",
    navLabel: "Personalization",
    description: "Explore version history, feed funnels, and recommender diagnostics.",
