...
export default async function ModelUsagePage(): Promise<React.JSX.Element> {
  const data = await getModelUsageData();
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Model Usage"
        description="Token and cost telemetry by model and action across the live LLM pipeline."
      />
