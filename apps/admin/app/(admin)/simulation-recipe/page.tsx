...
import { RecipeSimulationRunnerCard } from "@/components/admin/simulation-runner-card";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
import { getRecipeSimulationData } from "@/lib/admin-data";

export default async function RecipeSimulationsPage(): Promise<React.JSX.Element> {
  const data = await getRecipeSimulationData();
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Recipe Simulations"
        description="Live end-to-end recipe simulation runs with seeded natural prompts, real-time trace streaming, and per-step latency breakdowns."
      />
      ...
      <RecipeSimulationRunnerCard registryModels={data.registryModels} />
