...
const DEFAULT_MODELS = [
  { provider: "openai",    model: "gpt-5.1",             display_name: "GPT-5.1",          input_cost_per_1m_tokens: 1.25,  output_cost_per_1m_tokens: 10.00, context_window_tokens: 400000,  max_output_tokens: 128000, notes: "Current flagship GPT-5 model", ...TOKEN_BILLING },
  { provider: "openai",    model: "gpt-5",               display_name: "GPT-5",            input_cost_per_1m_tokens: 1.25,  output_cost_per_1m_tokens: 10.00, context_window_tokens: 400000,  max_output_tokens: 128000, notes: "High-quality GPT-5 model", ...TOKEN_BILLING },
  { provider: "openai",    model: "gpt-5-mini",          display_name: "GPT-5 Mini",       input_cost_per_1m_tokens: 0.25,  output_cost_per_1m_tokens: 2.00,  context_window_tokens: 400000,  max_output_tokens: 128000, notes: "Fast cost-efficient GPT-5 variant", ...TOKEN_BILLING },
  { provider: "openai",    model: "gpt-5-nano",          display_name: "GPT-5 Nano",       input_cost_per_1m_tokens: 0.05,  output_cost_per_1m_tokens: 0.40,  context_window_tokens: 400000,  max_output_tokens: 128000, notes: "Lowest-latency GPT-5 variant", ...TOKEN_BILLING },
  { provider: "openai",    model: "gpt-4.1",             display_name: "GPT-4.1",          input_cost_per_1m_tokens: 2.00,  output_cost_per_1m_tokens: 8.00,  context_window_tokens: 1000000, max_output_tokens: 32768,  notes: "Stable GPT-4.1 fallback", ...TOKEN_BILLING },
  ...
  { provider: "google",    model: "gemini-2.5-flash",       display_name: "Gemini 2.5 Flash",       input_cost_per_1m_tokens: 0.30, output_cost_per_1m_tokens: 2.50,  context_window_tokens: 1048576, max_output_tokens: 65536, notes: "Stable Gemini 2.5 Flash model", ...TOKEN_BILLING },
  { provider: "google",    model: "gemini-2.5-flash-lite",  display_name: "Gemini 2.5 Flash-Lite",  input_cost_per_1m_tokens: 0.10, output_cost_per_1m_tokens: 0.40,  context_window_tokens: 1048576, max_output_tokens: 65536, notes: "Stable Gemini 2.5 Flash-Lite model", ...TOKEN_BILLING },
  { provider: "google",    model: "gemini-2.5-pro",         display_name: "Gemini 2.5 Pro",         input_cost_per_1m_tokens: 1.25, output_cost_per_1m_tokens: 10.00, context_window_tokens: 1048576, max_output_tokens: 65536, notes: "Stable Gemini 2.5 Pro model", ...TOKEN_BILLING },
  { provider: "google",    model: "gemini-2.5-flash-image", display_name: "Gemini 2.5 Flash Image", input_cost_per_1m_tokens: 0.30, output_cost_per_1m_tokens: 0.00,  context_window_tokens: 65536,   max_output_tokens: 32768, notes: "Gemini 2.5 image generation model", ...GOOGLE_IMAGE_BILLING },
];
